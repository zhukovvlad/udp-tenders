...
def compute_export_rows(
    ...
    for br in base_rows:
        ...
        rows.append({
            ...
            "qty": round(qty, 3),
            "ref_price": ref_price,
            "mat_per_m3_excl_vat": round(mat_per_m3_excl_vat, 2),
            "vat_rate": vat_rate_decimal,              # decimal: 0.20 → shows as 20% in Excel
            "mat_per_m3": round(mat_per_m3, 2),
            "delivery_per_m3_excl_vat": round(delivery_per_m3_excl_vat, 2),
            "delivery_per_m3": round(delivery_per_m3, 2),
            "other_per_m3_excl_vat": round(other_per_m3_excl_vat, 2),
            "other_per_m3": round(other_per_m3, 2),
            "total_per_m3": round(total_per_m3, 2),
            "deviation_pct": deviation_pct,
            "deviation_amount": deviation_amount,
        })
