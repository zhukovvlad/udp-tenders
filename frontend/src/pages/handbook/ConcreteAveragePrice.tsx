  ...
  return (
    <article className="mx-auto max-w-3xl mt-6">
      ...
      <Section title="Разбор на примере" eyebrow="Как это считается">
        <p>
          Возьмём реальную накладную ЦБ-390 от ПК Термобетон (01.02.2025): 14 м³ В40 и 107 м³ В30, плюс 13 строк
          доставки на 111 000 ₽ и цементное молочко. Переключите класс, чтобы увидеть, как объёмная доля меняет
          разнесённую доставку и итоговую цену за кубометр.
        </p>
